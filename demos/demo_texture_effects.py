...
def create_sample_image(
    width: int = 400, height: int = 300, output_path: str = "sample_image.png"
):
    ...
    try:
        ...
        for i, color in enumerate(colors):
            ...
            y = 50 + (i % 2) * 100
            draw.rectangle(
                [x, y, x + 50, y + 50], fill=color, outline=(100, 100, 100), width=2
            )
        ...
        for i in range(3):
            ...
            y = 200
            draw.ellipse(
                [x, y, x + 40, y + 40], fill=colors[i], outline=(100, 100, 100), width=2
            )
...
def demonstrate_texture_effects():
    ...
    try:
        ...
        print("🔍 Check the generated images to see the texture effects")
