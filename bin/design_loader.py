    ...
    def validate_svg_colors(self, svg_path: Path) -> List[str]:
        ...
        try:
            ...
            for element in root.iter():
                ...
                if fill and fill not in allowed_colors and not fill.startswith('url(') and fill != 'none':
...
def main():
    ...
    parser.add_argument("--templates", action="store_true", help="List all scene templates")
    parser.add_argument("--validate", action="store_true", help="Validate all assets and templates")
