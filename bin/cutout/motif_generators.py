...
def pick_scene_colors(palette: List[str], n: int = 3, seed: Optional[int] = None) -> List[str]:
...
def _add_jitter(value: float, max_jitter: float = 2.0, seed: Optional[int] = None) -> float:
