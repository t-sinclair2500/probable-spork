...
def main():
    ...
    try:
        ...
        data = {"title_options":[f"{topic}: 5 Quick Tips"],
                "sections":[
                    {"id":1,"label":"Hook","beats":["Big promise","Why watch"],"broll":["typing","clock"]},
    ...
    outline_path = os.path.join(BASE,"scripts", f"{date_tag}_{re.sub(r'[^a-z0-9]+','-',topic.lower())}.outline.json")
