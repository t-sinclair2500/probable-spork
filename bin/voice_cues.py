...
def map_cues_to_scenes(
    cues: List[Tuple[int, int, str]], scenescript_path: str
    ...
    for scene in scene_timings:
        ...
        for cue_start, cue_end, cue_text in cues:
            ...
            tolerance = 300
            if (
                cue_start - tolerance <= scene_end
                and cue_end + tolerance >= scene_start
            ):
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate voiceover cues from SRT files"
    )
