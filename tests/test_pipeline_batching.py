...
class TestPipelineBatching:
    ...
    def test_optional_script_refinement_batch_missing_config(self, mock_run_step):
        ...
        # Verify all steps were called
        expected_calls = [
            call("niche_trends", required=True, brief_env=None, brief_data=None, models_config=None),
            call("llm_cluster", required=True, brief_env=None, brief_data=None, models_config=None),
            call("llm_outline", required=True, brief_env=None, brief_data=None, models_config=None),
            call("llm_script", required=True, brief_env=None, brief_data=None, models_config=None),
            call("research_collect", required=True, brief_env=None, brief_data=None, models_config=None),
            call("research_ground", required=True, brief_env=None, brief_data=None, models_config=None),
            call("fact_check", required=False, brief_env=None, brief_data=None, models_config=None),
            call("fetch_assets", required=True, brief_env=None, brief_data=None, models_config=None)
        ]
