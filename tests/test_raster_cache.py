...
class TestRasterizationMethods:
    ...
    def test_rasterize_svg_fallback_to_pillow(self, mock_pillow, mock_rsvg, mock_cairosvg):
    ...
    @patch('bin.cutout.raster_cache._rasterize_with_rsvg')
    @patch('bin.cutout.raster_cache._rasterize_with_pillow')
    def test_rasterize_svg_all_methods_fail(self, mock_pillow, mock_rsvg, mock_cairosvg):
