...
try:
    ...
    def test_texture_application():
        ...
        cfg = {
            ...
            "feather_px": 1.0,
            "posterize_levels": 4,
            "halftone": {"enable": True, "cell_px": 8, "angle_deg": 45, "opacity": 0.1},
        }
        ...
        assert not np.array_equal(
            original_array, textured_array
        ), "Image should be modified by textures"
    ...
    def test_deterministic_output():
        ...
        assert np.array_equal(
            array1, array2
        ), "Same seed + config should produce identical output"
