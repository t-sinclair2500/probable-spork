...
def test_texture_metadata_integration():
    ...
    try:
                    ...
                    "qa_results": [
                        {
                            ...
                            "contrast_result": {"ok": False, "fails": ["Contrast too low"]}
                        },
                        {
                            "attempt": 2,
        ...
        assert qa_summary["average_attempts_per_element"] == 2.0, "Average should be 2.0 (3 attempts / 2 elements)"
        ...
        metadata_path = write_animatics_metadata(test_slug, mock_texture_results, texture_config)
