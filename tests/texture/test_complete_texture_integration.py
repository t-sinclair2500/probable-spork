...
def test_complete_texture_integration():
    ...
    try:
        ...
        draw.rectangle([50, 50, 250, 150], fill='lightblue', outline='darkblue', width=3)
                    ...
                    "qa_results": [
                        {
                            ...
                            "contrast_result": {"ok": False, "fails": ["Contrast too low"], "warnings": [], "details": {}}
                        },
                        {
                            "attempt": 2,
        ...
        print(f"     - Total elements: {metadata_obj['textures']['summary']['total_elements']}")
        print(f"     - Success rate: {metadata_obj['textures']['summary']['success_rate']:.1%}")
        print(f"     - Dialback applied: {metadata_obj['textures']['summary']['dialback_applied']}")
        ...
        metadata_path = write_animatics_metadata(test_slug, mock_results, aggressive_config)
