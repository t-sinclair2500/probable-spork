...
def detect_hardware_tier(system_info):
    ...
    has_high_end_gpu = any(
        "RTX 3080" in gpu or "RTX 3090" in gpu or 
        "RTX 4080" in gpu or "RTX 4090" in gpu or
        "RTX 4070" in gpu
        for gpu in gpu_info
    )
...
def main():
    ...
    print(f"CPU: {system_info['cpu_count']} cores ({system_info['cpu_count_logical']} logical)")
